...
local function label(o)
    if o.focused then
        return colortext(o.name, (theme.menu_fg_focus or theme.fg_focus)), (theme.menu_bg_focus or theme.bg_focus)
    else
        return o.name, (theme.menu_bg_normal or theme.bg_normal)
    end
end
